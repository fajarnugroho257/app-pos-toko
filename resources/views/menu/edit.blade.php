    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <form action="{{ route('aksiUpdateMenuApp', [$detail->menu_id]) }}" method="POST">
                    @method('POST')
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            <select class="form-control select2" name="app_heading_id" style="width: 100%;">
                                ...
                                @foreach ($rs_head as $head)
                                    <option value="{{ $head->app_heading_id }}"
                                        {{ old('app_heading_id', $detail->app_heading_id) == $head->app_heading_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('menu_name', $detail->menu_name) }}" name="menu_name"
                                class="form-control" placeholder="Nama Child Menu">
                        </div>
                        <div class="form-group">
                            <label>Route</label>
                            <input type="text" value="{{ old('menu_url', $detail->menu_url) }}" name="menu_url"
